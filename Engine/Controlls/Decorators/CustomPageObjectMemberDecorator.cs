...
namespace Engine.Controlls.Decorators
{
    class CustomPageObjectMemberDecorator : DefaultPageObjectMemberDecorator, IPageObjectMemberDecorator
    {
        private IWebDriver driver;
        public CustomPageObjectMemberDecorator(IWebDriver driver) => this.driver = driver;
        ...
        //private Element GetElement(Type type, IWebElement webElement, IWebDriver baseDriver, string Name)
        //{
        //    return (Element)type
        //        .GetConstructor(new[] { typeof(IWebElement), typeof(IWebDriver), typeof(string) })
